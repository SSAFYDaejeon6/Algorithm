...
:--: | :---------: | :---------------------: | :------:  | :---------:  | :------: |
| 00 |  19942 | 다이어트 | G4 | [19942](https://www.acmicpc.net/problem/19942) |백준|


## 규칙
```
1. 일주일에 3문제를 정하고 월, 수, 금 23:59분 기준 제출
2. 난이도는 백준 골드 3 ~ 5 수준의 문제
